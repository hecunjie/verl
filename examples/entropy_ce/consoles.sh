...
MATH_EVAL_BACKEND=math_verify \
MODEL_PATH=/mnt/tidal-alsh01/dataset/zeus/hecunjie/models/Qwen/Qwen3-4B \
INPUT_DATA=/mnt/ali-sh-1/dataset/zeus/hecunjie/rl_data/grpo/math_hard_test.parquet \
OUTPUT_DIR=/mnt/tidal-alsh01/dataset/zeus/hecunjie/entropy_check/infer_topk_f_mc_compare_qwen3_4b_instruct_mc32_math_hard \
NPROC_PER_NODE=8 \
MAX_SAMPLES=2000 \
MAX_NEW_TOKENS=8192 \
