...
MODEL_PATH=/mnt/tidal-alsh01/dataset/zeus/hecunjie/models/Qwen/Qwen3-4B \
INPUT_DATA=/mnt/ali-sh-1/dataset/zeus/hecunjie/rl_data/grpo/aime2024_test.parquet \
OUTPUT_DIR=/mnt/tidal-alsh01/dataset/zeus/hecunjie/entropy_check/infer_topk_f_mc_compare_qwen3_4b_instruct_mcmax32_aime24 \
NPROC_PER_NODE=8 \
MAX_SAMPLES=500 \
MAX_NEW_TOKENS=8192 \
ENTROPY_THRESHOLD=1.0 \
...
MODEL_PATH=/mnt/tidal-alsh01/dataset/zeus/hecunjie/models/Qwen/Qwen3-4B \
INPUT_DATA=/mnt/ali-sh-1/dataset/zeus/hecunjie/rl_data/grpo/aime2024_test.parquet \
OUTPUT_DIR=/mnt/tidal-alsh01/dataset/zeus/hecunjie/entropy_check/qwen3-4b_passk_32/maxfmc_nonbranch_greedy_aime24_batch_mc32_entropy1.0_maxk32 \
NPROC_PER_NODE=8 \
MAX_SAMPLES=500 \
MAX_NEW_TOKENS=8192 \
ENTROPY_THRESHOLD=1 \
